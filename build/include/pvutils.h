#ifndef PVUTILS_H_DEF
#define PVUTILS_H_DEF
...
size_t fromString(PVUnionPtr const & pvUnion, StringArray const & from, size_t fromStartIndex);
size_t fromString(PVUnionArrayPtr const &pv, StringArray const & from, size_t fromStartIndex);
size_t fromString(PVStructurePtr const & pvStructure, StringArray const & from, size_t fromStartIndex);
size_t fromString(PVFieldPtr const & fieldField, StringArray const & from, size_t fromStartIndex);
size_t fromString(PVStructureArrayPtr const &pv, StringArray const & from, size_t fromStartIndex);




extern EnumMode enumMode;
